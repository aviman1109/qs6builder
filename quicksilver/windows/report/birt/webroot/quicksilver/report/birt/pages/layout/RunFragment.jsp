...
<HTML lang="<%= attributeBean.getLanguage() %>">
	<HEAD>
		...
		<script type="text/javascript">
			...
			{
			%>
			var soapURL = "<%= org.apache.commons.lang.StringEscapeUtils.escapeHtml((String)request.getAttribute("SoapURL"))%>";			
			<%
			}
			else
			{
	...
	<script type="text/javascript">
		...
		{
			location.href = location["\x68\x72\x65\x66"].replace(/#.*/, "") + "#" + birtUtility.htmlDecode(bookmark);
			/*
