...
set SERVICE_NAME=%1
set DISPLAYNAME=%1
set DESCRIPTION=%1 on Apache Tomcat
shift
if "x%1x" == "xx" goto checkServiceCmd
goto checkUser
:runAsUser
