var EntityList =
{
	...
	loadLeftZone: function()
	{
		...
		if (EntityList.hasQueryForm && !EntityList.hasTree) {
	...
	doDelete: function(event)
	{
		...
		Jui.message.confirm(EntityList.getDeleteConfirmMessage(), function() {
	...
	{
		EntityList.exportExcel();
	},
	
	exportExcel: function(fieldNames)
	{
		if (list.length() == 0) {
