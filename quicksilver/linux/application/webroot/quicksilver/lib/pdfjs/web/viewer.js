...
var PDFViewerApplication = {
  ...
  viewerPrefs: {
    ...
    pdfBugEnabled: true, // false, Quicksilver
...
function getQuicksilverPreviewUrl(diskFileId)
{
  //var args = {diskFileId:diskFileId};
  //return base + "Qs.DiskFile.GetPreviewFlash.file?args=" + encodeURIComponent(JSON.stringify(args));
  var base = window.location.href.replace(/quicksilver\/lib\/pdfjs\/web\/viewer.html.*$/, "");
  return base + "Preview.file?diskFileId=" + diskFileId;
}
...
function webViewerInitialized() {
  ...
  //------------------------------------------------------------------
  // Modified:
  file = getQuicksilverPreviewUrl(params.diskfileid);
  //------------------------------------------------------------------
    ...
    value: function open() {
      ...
      this.overlayManager.open(this.overlayName).then(function () {
        ...
        if (_this2.reason === _pdfjsLib.PasswordResponses.INCORRECT_PASSWORD) {
          promptString = _this2.l10n.get('xword_invalid', null, 'Invalid password. Please try again.');
        } else {
          promptString = _this2.l10n.get('xword_label', null, 'Enter the password to open this PDF file.');
        }
