...
<%@ page import="org.eclipse.birt.report.resource.BirtResources,
				 org.eclipse.birt.report.QsBirtConstants" %>
...
<HTML>
	<HEAD>
		...
		<LINK REL="stylesheet" HREF="<%= request.getContextPath( ) + QsBirtConstants.BIRT_PATH + "/styles/style.css" %>" TYPE="text/css">
	</HEAD>
	<BODY STYLE="background-color: #ECE9D8;">
		<DIV ID="progressBar" ALIGN="center">
			<TABLE WIDTH="250px" CLASS="birtviewer_progresspage" CELLSPACING="10px">
				...
				<TR>
					<TD ALIGN="center">
						<IMG SRC="<%= request.getContextPath( ) + QsBirtConstants.BIRT_PATH + "/images/" + (rtl?"Loading_rtl":"Loading") + ".gif" %>" ALT="Progress Bar Image"/>
					</TD>
				</TR>
			</TABLE>
		</DIV>
